    ...
    function myFunction() {
        ...
        const leftHead = document.getElementById("logo");
        const rightHead = document.getElementById("header-right");
        const sideNav = document.getElementById("mySidenav");
        const darkClass = ["heading","top-wrapper","message-wrapper","contact-wrapper" ]
      ...
      if (checkBox.checked === true){
        ...
        sideNav.style.backgroundColor = "rgb(69, 76, 83)";
        darkHead.style.backgroundColor = "rgb(69, 76, 83)";
        /*header-right and left darker*/
        
        for(let i=0; i<aRight.length; i++){
            aRight[i].style.color = "white";
           
        }
        for(let i=0; i<aSide.length; i++){
            aSide[i].style.color = "white";
       ...
       for(let j=0; j<darkClass.length; j++){
        ...
        sideNav.style.backgroundColor = "rgb(247, 247, 247)";
        leftHead.style.color="rgb(69, 76, 83)" ;
        menuIcon.style.color = "rgb(69, 76, 83)";
        darkHead.style.backgroundColor = "rgb(247, 247, 247)";
